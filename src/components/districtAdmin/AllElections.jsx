    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 p-6">
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        {!loading && elections.length === 0 && (
          <div className="text-center py-20 bg-white bg-opacity-10 rounded-3xl backdrop-blur animate-scaleIn">
            <svg className="w-24 h-24 mx-auto mb-6 text-white opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
            </svg>
            <h3 className="text-3xl font-bold text-white mb-3">No Elections Available</h3>
            <p className="text-blue-200 text-lg">Check back later for upcoming elections</p>
          </div>
        )}
